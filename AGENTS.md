The full design record (why `vt100` was retired, the borrow/re-implement ledger, correctness guarantees) lives in the [Capsule Terminal Model](../../docs/content/reference/capsule/terminal-model.mdx) doc — read it before changing the model.
